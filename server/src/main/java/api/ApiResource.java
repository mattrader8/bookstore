...
public class ApiResource
{
                                 ...
                                 @Context HttpServletRequest httpRequest)
    {
        try
        {
            ...
            if (result == null)
            {
                throw new ApiException(String.format("No such categoryId: %d", categoryId));
            }
            return result;
        }
        catch (Exception e)
        {
            throw new ApiException(String.format("Category lookup by categoryId %d failed", categoryId), e);
        }
    }
                         ...
                         @Context HttpServletRequest httpRequest)
    {
        try
        {
            ...
            if (result == null)
            {
                throw new ApiException(String.format("No such bookId: %d", bookId));
            }
            return result;
        }
        catch (Exception e)
        {
            throw new ApiException(String.format("Book lookup by bookId %d failed", bookId), e);
        }
    }
                                        ...
                                        @Context HttpServletRequest httpRequest)
    {
        ...
        {
            throw new ApiException(String.format("Books lookup by categoryId %d failed", categoryId), e);
        }
    }

    // get suggested books by categoryId
    @GET
                                     ...
                                     @Context HttpServletRequest request)
    {
        ...
        {
            throw new ApiException("Books lookup via categoryId failed", e);
        }
    }
            ...
            @Context HttpServletRequest httpRequest)
    {
        try
        {
            ...
            if (result == null)
            {
                throw new ApiException("No such categoryName: " + categoryName);
            }
            return result;
        }
        catch (Exception e)
        {
            throw new ApiException(("Category lookup by categoryName " + categoryName + " failed"), e);
        }
    }
    ...
    // get suggested books by categoryName
    @GET
